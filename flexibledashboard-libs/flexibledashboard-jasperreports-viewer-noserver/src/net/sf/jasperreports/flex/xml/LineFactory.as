...
package net.sf.jasperreports.flex.xml
{
	...
	{
		public static function create(xml:XML):Line 
		{
			var line:Line = new Line();
			
			ElementFactory.setElement(xml.reportElement[0], line);
			GraphicElementFactory.setGraphicElement(xml.graphicElement[0], line);
			
			if (xml.@direction.length() > 0) 
			{
				line.direction = xml.@direction;
			}
