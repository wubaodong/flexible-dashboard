...
package net.sf.jasperreports.flex.xml
{
	...
	{
		public static function create(xml:XML):Ellipse 
		{
			var ellipse:Ellipse = new Ellipse();
			
			ElementFactory.setElement(xml.reportElement[0], ellipse);
			GraphicElementFactory.setGraphicElement(xml.graphicElement[0], ellipse);
