...
package net.sf.jasperreports.flex.model 
{
	...
	{
		public static const TRUE:BooleanEnum = new BooleanEnum(true);
		public static const FALSE:BooleanEnum = new BooleanEnum(false);
		
		private var _booleanValue:Boolean;
		
		public function BooleanEnum(booleanValue:Boolean)
		{
